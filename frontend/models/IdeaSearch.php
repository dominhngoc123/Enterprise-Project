...
/**
 * IdeaSearch represents the model behind the search form of `frontend\models\Idea`.
 */
class IdeaSearch extends Idea
{
    ...
    {
        return [
            [['id', 'parentId', 'userId', 'categoryId', 'campaignId', 'upvote_count', 'downvote_count', 'post_type', 'status'], 'integer'],
